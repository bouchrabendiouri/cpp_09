...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/17 10:11:02 by bbendiou          #+#    #+#             */
/*   Updated: 2024/05/17 11:04:16 by bbendiou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
BitcoinExchange::BitcoinExchange(const std::string& filename)
{
    ...
    while (std::getline(file, line))
    {
        ...
        std::string value_str = line.substr(delim + 1, line.length());
...
void BitcoinExchange::ProcessInput(const std::string &filename) {
	...
	while (std::getline(file, line)) {
		...
		double exchangeRate = GetExchangeValue(date);
		if (exchangeRate == -1.0) {
...
double BitcoinExchange::GetExchangeValue(const std::string &date) {
